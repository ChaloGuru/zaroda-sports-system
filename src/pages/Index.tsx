...
const categories: GameCategory[] = ['ball_games', 'athletes', 'music', 'other'];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32 relative">
          <div className="text-center">
            ...
            <p className="text-lg md:text-xl text-white/80 max-w-2xl mx-auto mb-8">
              Track competitions from Zone to National level. View participants, results, 
              and qualifiers across all sporting categories.
            </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {categories.map(category => (
              <CategoryCard 
                key={category} 
                category={category} 
                gameCount={getGameCount(category)}
              />
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-primary-foreground/60 text-sm">
              © 2024 Zaroda Sports System. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
